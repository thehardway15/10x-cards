...
export function SourceTextInput({ onSubmit, isLoading }: SourceTextInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">{errors.sourceText?.message || "\u00A0"}</p>
        <Button type="submit" disabled={!isValid || isLoading} data-testid="generate-button">

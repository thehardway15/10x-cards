...
describe("CandidateListItem Component", () => {
  ...
  it("calls onAccept when accept button is clicked", async () => {
    ...
    const { user } = render(<CandidateListItem {...defaultProps} onAccept={onAccept} />);
  ...
  it("calls onEdit when edit button is clicked", async () => {
    const onEdit = vi.fn();
    const { user } = render(<CandidateListItem {...defaultProps} onEdit={onEdit} />);
  ...
  it("calls onReject when reject button is clicked", async () => {
    ...
    const { user } = render(<CandidateListItem {...defaultProps} onReject={onReject} />);

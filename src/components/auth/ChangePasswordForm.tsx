...
export function ChangePasswordForm() {
  ...
  const handleNewPasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setErrors({
      ...
      confirmNewPassword: newPassword !== formData.confirmNewPassword ? "Passwords do not match" : "",
    });
  };
  ...
  const handleConfirmNewPasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setErrors({
      ...errors,
      confirmNewPassword: confirmNewPassword !== formData.newPassword ? "Passwords do not match" : "",
    });
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (passwordError || formData.newPassword !== formData.confirmNewPassword) {
      setErrors({
        ...
        confirmNewPassword: formData.newPassword !== formData.confirmNewPassword ? "Passwords do not match" : "",
      });
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input
            id="newPassword"
            type="password"
            className={`w-full px-3 py-2 border rounded-md ${errors.newPassword ? "border-destructive" : ""}`}
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            type="password"
            className={`w-full px-3 py-2 border rounded-md ${errors.confirmNewPassword ? "border-destructive" : ""}`}

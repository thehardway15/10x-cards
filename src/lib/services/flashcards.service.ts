...
import type { FlashcardDto, ListFlashcardsResponseDto, DetailedFlashcardDto, BulkCreateFlashcardsCommand, UpdateFlashcardCommand } from '../../types';
...
export class FlashcardsService {
  ...
  async listFlashcards(
    userId: string,
    params: ListFlashcardsQuerySchema
